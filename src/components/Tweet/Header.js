...
class Header extends Component {
  ...
  render () {
    const {data, linkProps, imagePathCriteria} = this.props;
    ...
    return (
      <div className='header'>
        <a className='account-group' style={styles.accountGroup} href={`https://example.com/${data.user.screen_name}`} {...linkProps}>
          <img alt='' className='avatar' src={imagePathCriteria} style={styles.avatar} />
        ...
        <small className='time' style={styles.time}>
          <a href={`https://example.com/${data.user.screen_name}/status/${data.id_str}`} className='tweet-timestamp' style={styles.timestamp} {...linkProps}>
            {' • '}{timestamp}
          </a>
        </small>
        <a href={`https://example.com/${data.user.screen_name}/status/${data.id_str}`} title='View on Twitter' {...linkProps}>
